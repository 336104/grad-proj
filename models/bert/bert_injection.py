...
class BertForTokenClassification_(BertPreTrainedModel):
    def __init__(self, config):
        ...
        self.bert = BertModel_(config, add_pooling_layer=False)
        classifier_dropout = (
...
class BertModel_(BertPreTrainedModel):
    ...
    def __init__(self, config, add_pooling_layer=True):
        ...
        self.encoder = BertEncoder_(config)
...
class BertLayer_dummpy(BertLayer):
    def forward(self, border_labels, *args, **kwargs):
